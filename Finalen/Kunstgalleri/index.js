...
app.post("/submit", (req, res) => {
    ...
    let data = {
        ...
        kundemelding: req.body.melding,
        kundeemne: req.body.emne
    };
    sendEpost(data);
...
function sendEpost(data){
    ...
    <p>Takk for din melding. Her en en kopi av meldingen du sendte:</p>
    <p>${data.kundemelding}</p>
    <p>Med vennlig hilsen</p>
    <p><strong>Kunstnern</strong></p>
    <img width="200px" src="https://picsum.photos/400?random=1" alt="">`;

    let mailOptions = {
        from: email,
        to: data.kundeepost,
        subject: `${data.kundeemne} | Bestillingskjema`,
